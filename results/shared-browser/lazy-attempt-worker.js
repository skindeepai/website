...
onmessage=async({data:message})=>{try{
 ...
 const setup={adaptiveMs:r.adaptiveSetupMs,controlMs:r.controlSetupMs,cumulativeMs:r.setupMs,incrementalMs:r.setupMs-previousSetupMs};send('setup',setup);
